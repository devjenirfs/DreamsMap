      ...
      <div className={`bg-gradient-to-r ${category.gradient} p-[24px]`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-[16px]">
            ...
            <div>
              ...
              <p className="text-[#FFFFFFE6] text-[14px] mt-[4px]">
                {completedCount} de {totalCount} conquistas
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-[12px]">
            ...
            >
              <Plus size={20} />
              <span className="font-semibold">Adicionar Sonho</span>
            </motion.button>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => {
                if (window.confirm('Remover esta categoria? Isso apagará todos os sonhos dela.')) {
                  onDeleteCategory();
                }
              }}
        ...
        {category.dreams.length === 0 ? (
          <div className="text-center py-[48px]">
            <p className="text-[#9CA3AF] text-[18px]">
              Adicione seu primeiro sonho nesta categoria ✨
            </p>
          </div>
        ) : (
