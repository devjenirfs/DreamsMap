      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-[16px]">
        ...
        >
          <div className={`p-[24px] ${previewGradientClass}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-[12px]">
                ...
                <div>
                  <h2 className="text-[24px] font-bold text-[#FFFFFF]">Criar Categoria</h2>
                  <p className="text-[#FFFFFFE6] text-[14px] mt-[4px]">Defina nome, emoji e cores</p>
                </div>
              </div>
              <button
                onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="p-[24px] space-y-[16px]">
            <div>
              <label className="block text-[14px] font-semibold text-[#374151] mb-[8px]">Título *</label>
              <input
                value={title}
            ...
            <div className="grid grid-cols-2 gap-[12px]">
              <div>
                <label className="block text-[14px] font-semibold text-[#374151] mb-[8px]">Cor</label>
                <select
                  value={fromColor}
              ...
              <div>
                <label className="block text-[14px] font-semibold text-[#374151] mb-[8px]">Cor 2</label>
                <select
                  value={toColor}
            ...
            <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-[12px] p-[16px]">
              <p className="text-[12px] text-[#6B7280]">
                Escolha duas cores para o degradê da categoria.
              </p>
            </div>
